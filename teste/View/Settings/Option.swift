...
extension Option {
    static let generalValues: [InnerOptionValues] = [
        ...
        .init(title: "Reset", isAddSection: true, isUseToggle: false, headerTitle: "", image: "exclamationmark.bubble")
    ]
    ...
    static let options: [Option] = [
        .init(id: 1, title: "General", isAddSection: false, values: generalValues, image: "gear"),
        .init(id: 2, title: "Accessibility", isAddSection: false, values: accessibilityValues, image: "person"),
        .init(id: 3, title: "Privacy", isAddSection: false, values: privacyValues, image: "hand.raised"),
        .init(id: 4, title: "Password & Accounts", isAddSection: true, values: passwordAndAccountsValues, image: "pencil"),
        .init(id: 5, title: "Maps", isAddSection: false, values: mapsValues, image: "map"),
        .init(id: 6, title: "Safari", isAddSection: false, values: safariValues, image: "safari"),
        .init(id: 7, title: "News", isAddSection: false, values: newsValues, image: "paperplane"),
        .init(id: 8, title: "Developer", isAddSection: true, values: developerValues, image: "keyboard.chevron.compact.down")
    ]
}
